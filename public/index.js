document.addEventListener("DOMContentLoaded", function() {
    ...
    footerDropdownElement.addEventListener('click', footerdropdownClickHandle);
  });
  ...
  // navbar on click
    ...
    const navbarDropdown = document.querySelector('.navbar-btn-dropdown')
    const navbarDropdownElement = document.querySelector('header')
  ...
  if (navBarActive) {
    ...
    const navbarDropdownElements = document.querySelectorAll('.navbar-dropdown')

    navbarDropdownElements.forEach(element => {
      ...
      navbarDropdownElement.addEventListener('click', navbardropdownClickHandle);
    })
    ...
    function handleEvents(){
      ...
      const popUpSection = ` 
        <form class="form-popup-wrap " id="popup-form">
                ...
                <div class="mid-popup-flex">
                  <div class="input-wapper ">
                    <div class="input-color name&surname-input" >
                      <input type="text" maxlength="256" required class="info-input name-surname" placeholder=" " name="infoName" id="fullName">
                  ...
                  <div class="input-wapper">
                    <div class="input-color email-input">
                      <input type="email" maxlength="256" required class="info-input email" placeholder=" " id="email_id">
                  ...
                  <div class="input-wapper">
                    <div class="input-color text-input-div">
                      <textarea maxlength="256" required class="info-input text-input" name="infoText" id="message" ></textarea>
  ...
  // Set dropdown text based on the current language
  let dropdownText = "";
  
  if (currentLeanguage === "Eng") {
      dropdownText = dropTextEng;
  } else {
      dropdownText = dropTextGeo;
  }

       const navbarDropdownitemElement = 
       `
      <div class='navbar-btn-dropdown'>
        <div class="padding-default">
          <div class="mid-navbar-responsive">
            <div class="navbar-products-div">
              <div class="navbar-dropdown navbar-products">
                <a data-v-174d8ed1="" href="https://tbcconcept.ge/ge/products/overview" class="navbar-drop_down-toggle-kink"> <h2> ${dropdownText[0]} </h2></a>
                  <svg class="navbar-products-img dropdown-img" width="28" height="29" viewbox="0 0 28 29" fill="none" xmlns="http://www.w3.org/2000/svg"><path data-v-174d8ed1="" d="M13.9986 18.6685C13.7326 18.6685 13.4678 18.5787 13.2519 18.3979L6.25193 12.5645C5.75726 12.1527 5.68959 11.4165 6.10259 10.9219C6.51443 10.4272 7.24943 10.3607 7.74526 10.7725L14.0114 15.9945L20.2671 10.9604C20.7688 10.5567 21.5038 10.636 21.9074 11.1377C22.3111 11.6394 22.2318 12.3732 21.7301 12.778L14.7301 18.4107C14.5166 18.5822 14.2576 18.6685 13.9986 18.6685Z" fill="#141719"></path><mask data-v-174d8ed1="" id="mask0_167_5088" maskunits="userSpaceOnUse" x="5" y="10" width="18" height="9" style="mask-type: luminance;"><path data-v-174d8ed1="" d="M13.9986 18.6685C13.7326 18.6685 13.4678 18.5787 13.2519 18.3979L6.25193 12.5645C5.75726 12.1527 5.68959 11.4165 6.10259 10.9219C6.51443 10.4272 7.24943 10.3607 7.74526 10.7725L14.0114 15.9945L20.2671 10.9604C20.7688 10.5567 21.5038 10.636 21.9074 11.1377C22.3111 11.6394 22.2318 12.3732 21.7301 12.778L14.7301 18.4107C14.5166 18.5822 14.2576 18.6685 13.9986 18.6685Z" fill="white"></path></mask><g data-v-174d8ed1="" mask="url(#mask0_167_5088)"></g></svg>
              </div>
                <div class='navbar-dropdown-item'>
                  <div class="navbar-dropdown-list">
                    <div> <a href="https://tbcconcept.ge/ge/products/kits" class="navbar-dropdown-link"> <p> ${dropdownText[1]} </p> </a> </div>
                    <div> <a href="https://tbcconcept.ge/ge/products/personalbanker" class="navbar-dropdown-link"> <p> ${dropdownText[2]}</p></a> </div>
                  </div>
                </div>
            </div>
            <div class="navbar-lifestyle-div">
              <div class="navbar-dropdown navbar-lifestyle">
                <a data-v-174d8ed1="" href="https://tbcconcept.ge/ge/lifestyle/overview" class="navbar_dropdown-toggle-kink"> <h2> ${dropdownText[3]} </h2></a>
                  <svg class="navbar-lifestyle-img dropdown-img" width="28" height="29" viewbox="0 0 28 29" fill="none" xmlns="http://www.w3.org/2000/svg"><path data-v-174d8ed1="" d="M13.9986 18.6685C13.7326 18.6685 13.4678 18.5787 13.2519 18.3979L6.25193 12.5645C5.75726 12.1527 5.68959 11.4165 6.10259 10.9219C6.51443 10.4272 7.24943 10.3607 7.74526 10.7725L14.0114 15.9945L20.2671 10.9604C20.7688 10.5567 21.5038 10.636 21.9074 11.1377C22.3111 11.6394 22.2318 12.3732 21.7301 12.778L14.7301 18.4107C14.5166 18.5822 14.2576 18.6685 13.9986 18.6685Z" fill="#141719"></path><mask data-v-174d8ed1="" id="mask0_167_5088" maskunits="userSpaceOnUse" x="5" y="10" width="18" height="9" style="mask-type: luminance;"><path data-v-174d8ed1="" d="M13.9986 18.6685C13.7326 18.6685 13.4678 18.5787 13.2519 18.3979L6.25193 12.5645C5.75726 12.1527 5.68959 11.4165 6.10259 10.9219C6.51443 10.4272 7.24943 10.3607 7.74526 10.7725L14.0114 15.9945L20.2671 10.9604C20.7688 10.5567 21.5038 10.636 21.9074 11.1377C22.3111 11.6394 22.2318 12.3732 21.7301 12.778L14.7301 18.4107C14.5166 18.5822 14.2576 18.6685 13.9986 18.6685Z" fill="white"></path></mask><g data-v-174d8ed1="" mask="url(#mask0_167_5088)"></g></svg>
              </div>
                <div class='navbar-dropdown-item'>
                  <div class="navbar-dropdown-list">
                    <div> <a href="https://tbcconcept.ge/ge/lifestyle/offers" class="navbar-dropdown-link"><p> ${dropdownText[4]} </p> </a> </div>
                    <div> <a href="https://tbcconcept.ge/ge/lifestyle/events" class="navbar-dropdown-link"><p> ${dropdownText[5]} </p></a> </div>
                  </div>
                </div>
              </div>

            <div class="navbar-concept-space-div">
              <div class="navbar-dropdown navbar-concept-space">
                <a data-v-174d8ed1="" href="https://tbcconcept.ge/ge/concept-space/overview" class="navbar_dropdown-toggle-kink"> <h2> ${dropdownText[6]} </h2></a>
                  <svg class="navbar-concept-space-img dropdown-img" width="28" height="29" viewbox="0 0 28 29" fill="none" xmlns="http://www.w3.org/2000/svg"><path data-v-174d8ed1="" d="M13.9986 18.6685C13.7326 18.6685 13.4678 18.5787 13.2519 18.3979L6.25193 12.5645C5.75726 12.1527 5.68959 11.4165 6.10259 10.9219C6.51443 10.4272 7.24943 10.3607 7.74526 10.7725L14.0114 15.9945L20.2671 10.9604C20.7688 10.5567 21.5038 10.636 21.9074 11.1377C22.3111 11.6394 22.2318 12.3732 21.7301 12.778L14.7301 18.4107C14.5166 18.5822 14.2576 18.6685 13.9986 18.6685Z" fill="#141719"></path><mask data-v-174d8ed1="" id="mask0_167_5088" maskunits="userSpaceOnUse" x="5" y="10" width="18" height="9" style="mask-type: luminance;"><path data-v-174d8ed1="" d="M13.9986 18.6685C13.7326 18.6685 13.4678 18.5787 13.2519 18.3979L6.25193 12.5645C5.75726 12.1527 5.68959 11.4165 6.10259 10.9219C6.51443 10.4272 7.24943 10.3607 7.74526 10.7725L14.0114 15.9945L20.2671 10.9604C20.7688 10.5567 21.5038 10.636 21.9074 11.1377C22.3111 11.6394 22.2318 12.3732 21.7301 12.778L14.7301 18.4107C14.5166 18.5822 14.2576 18.6685 13.9986 18.6685Z" fill="white"></path></mask><g data-v-174d8ed1="" mask="url(#mask0_167_5088)"></g></svg>
              </div>
                <div class='navbar-dropdown-item '>
                  <div class="navbar-dropdown-list">
                    <div> <a href="https://tbcconcept.ge/ge/concept-space/library" class="navbar-dropdown-link"><p> ${dropdownText[7]} </p></a> </div>
                    <div> <a href="https://tbcconcept.ge/ge/concept-space/cafe" class="navbar-dropdown-link"> <p> ${dropdownText[8]} </p></a> </div>
                  </div>
                </div>
            </div>
            <div class="navbar-dropdown navbar-contact-us">
              <div class="navbar-info">
                <div class="navbar-title">
                  <a data-v-174d8ed1="" href="/ge/products/overview" class="navbar_dropdown-toggle-kink"> <h2> ${dropdownText[9]} </h2></a>
                </div>

                <address class="navbar-info-flex">
                ...
                <p class="footer-header">  ${dropdownText[11]}  </p>
