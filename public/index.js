document.addEventListener("DOMContentLoaded", function() {
    ...
    <div class="drop-btn-flex">
      ...
      <div class="comment-flex">
        ...
        <div class="comment-div call-drop-div"> 
          <div class="button-menu_tooltip">
          <div class="button-menu_tooltip-text ">${textBtnDiv[1]} </a> </div>
          <div  class="button-menu_tooltip-arrow w-embed"><svg  width="8" height="24" viewBox="0 0 8 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path  d="M6.87662 14.8284L1.12339 20.8284C0.404095 21.5786 7.66111e-07 22.596 8.12483e-07 23.6569L2.04844e-07 0.343145C2.51216e-07 1.40401 0.404094 2.42143 1.12339 3.17157L6.87661 9.17157C8.37446 10.7337 8.37446 13.2663 6.87662 14.8284Z" fill="#424A4D"></path></svg></div></div> 
        </div>
      </div>
    ...
    <div class="comment-flex">
      <div class="drop-btn-item location-drop">
        ...
        <a class="comment-div location-drop-div">
          <div  class="button-menu_tooltip">
  ...
  return true;
      ...
      const popUpSection = ` 
      <form class="info-form" onsubmit="handleFormSubmit(event)">
                ...
                <div class="mid-popup-flex">
                  <div class="input-wapper">
                    <div class="input-color name&surname-input" >
                      <input type="text" maxlength="256" required="required" class="name-surname" placeholder=" " name="infoName">
                  ...
                  <div class="input-wapper">
                    <div class="input-color number-input">
                      <input type="number" min="100000000" required class="number" placeholder=" " name="infoNumber">
                  ...
                  <div class="input-wapper">
                    <div class="input-color email-input">
                      <input type="email" maxlength="256" required="required" class="email" placeholder=" " name="infoEmail">
                  ...
                  <div class="input-wapper">
                    <div class="input-color company-input">
                      <input type="text" maxlength="256" class="company" placeholder=" " name="infoCompany">
                  ...
                  <div class="input-wapper">
                    <div class="input-color text-input-div">
                      <textarea maxlength="256" required="required" class="text-input" name="infoText"></textarea>
